...
![Illustration af middelværdisætningen.](images/middelvaerdisaetningen.png){#fig-middelvaerdisaetningen}
...
f\left( x_{0} + h \cdot u_{1},y_{0} +  h \cdot u_{2} \right) & - f\left( x_{0},y_{0} + h \cdot u_{2} \right)  + f\left( x_{0},y_{0} + h \cdot u_{2} \right) - f(x_{0},y_{0})
\end{align*}
...
afledede eksistere og give det ønskede resultat
...
punktet til, så kan nogle af de følgende punkter ses i @fig-gradientnedstigning.

::: {#fig-gradientnedstigning}

![](images/numerisk1.png)
![](images/numerisk2.png)

Illustration af udviklingen ved gradientnedstigning.
:::
...
Læs flere anvendelser af gradientnedstigning her: [Perceptroner](../perceptron-note/perceptron-note.qmd) og [Kunstige neurale netværk](../neurale_net-note/neurale_net-note.qmd)