...
Vi ser nu, at de to første led kun afviger på $x$-koordinaten (markeret med blåt nedenfor), og de to sidste led afviger
kun på $y$-koordinaten (markeret med grønt): 
$$
\begin{aligned}
f\left( x_{0} + h \cdot u_{1},y_{0} + h \cdot u_{2} \right) - f(x_{0},y_{0})   &= \\
...
Ved at bruge den omkskrevne middelværdisætning i (@eq-middel_omskrevet) på de to
